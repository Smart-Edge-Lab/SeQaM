...
save_image_as_tar seqam-central seqam.central "${EDPAPI_IMAGE_NAME}" "${SEQAM_COMMAND_TRANSLATOR_IMAGE_NAME}" \
  "${SEQAM_EVENT_ORCHESTRATOR_IMAGE_NAME}" "${SEQAM_EXPERIMENT_DISPATCHER_IMAGE_NAME}"
...
save_image_as_tar seqam-distributed-event-manager seqam-distributed-event-manager "${SEQAM_DISTRIBUTED_EVENT_MANAGER_IMAGE_NAME}"
...
save_image_as_tar seqam-network-event-manager seqam-network-event-manager "${SEQAM_NETWORK_EVENT_MANAGER_IMAGE_NAME}"
